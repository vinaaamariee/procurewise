...
export default function NotificationsPage() {
  ...
  const markRead = trpc.procurement.notifications.markRead.useMutation({ onSuccess: () => void utils.procurement.dashboard.invalidate() });

...
function OfficialFormHeader({ audience }: { audience: SupplierEvaluationAudience }) { return <header className="border-b-[3px] border-[#9a6d19] px-5 pb-4 pt-6 text-center"><p className="font-display text-lg font-bold text-[#202833] dark:text-[#ffffff]">BATANES STATE COLLEGE</p><p className="mt-1 text-[10px] font-semibold uppercase tracking-[0.16em] text-[#7b1e1e] dark:text-[#ff837a]">Procurement Unit</p><h1 className="mt-4 text-base font-bold text-[#202833] dark:text-[#ffffff]">SUPPLIER EVALUATION FORM</h1><p className="text-sm font-semibold text-[#1f2933] dark:text-[#f1f5f8]">(Goods)</p><p className="mt-2 text-xs italic text-[#52606d] dark:text-[#d1dae2]">To be accomplished by {audience === "end_user" ? "end-user" : "Procurement Office"}</p></header>; }

...
export function SupplierEvaluationFormPage() {
  ...
  return <div className="mx-auto max-w-[1120px] py-1">
    ...
    <div className="flex flex-wrap items-end justify-between gap-5 px-5 pb-5 pt-6 sm:px-7"><div className="w-full max-w-md"><Label htmlFor="respondent-name" className="text-[11px] text-[#1f2933] dark:text-[#f1f5f8]">Name and Signature of Respondent:</Label><Input id="respondent-name" value={respondentName} onChange={(event) => setRespondentName(event.target.value)} className="mt-1 h-8 rounded-none border-x-0 border-t-0 border-b border-[#222] dark:border-[#64717d] dark:bg-[#1b2229] dark:text-[#f1f5f8] px-0 text-xs shadow-none" maxLength={180} /></div><div className="w-40"><Label className="text-[11px] text-[#1f2933] dark:text-[#f1f5f8]">Date:</Label><div className="mt-1 h-8 border-b border-[#222] dark:border-[#64717d] pt-1 text-xs text-[#1f2933] dark:text-[#f1f5f8]">{new Date().toLocaleDateString("en-PH")}</div></div><Button disabled={isSaving} className="h-9 rounded-[4px] bg-[#7b1e1e] text-xs text-white hover:bg-[#641818] dark:bg-[#d65c50] dark:text-white dark:hover:bg-[#eb766a]">{isSaving && <LoaderCircle className="mr-1.5 h-3.5 w-3.5 animate-spin text-white" />}Submit</Button></div>
    <OfficialFormFooter />
